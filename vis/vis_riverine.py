...
def plot_combined_results(regions, countries):
    ...
    for ax, (metric, title) in zip(axes, metrics.items()):
        ...
        # Treat missing and non-positive results as N/A. Some countries have no
        # regional records at all, so the complete country layer is also drawn
        # in the N/A colour before valid regional results are overlaid.
        ...
        # Paint every country grey first. This covers countries and territories
        # with no matching regional result instead of leaving them white.
