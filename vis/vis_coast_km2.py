...
def plot_regional_results(regions, path, countries):
    """
    Plot regions by geotype using decile-based binning.
    """
    regions['cost_per_km2'] = regions['cost_per_k'].fillna(0)
    regions['cost_per_km2'] = round(regions['cost_per_km2'], 0)
    
    bins = [-10, 20, 40, 60, 80, 100, 120, 140, 160, 1e12]
    labels = ['$<20/km²','$40/km²','$60k/km²','$80k/km²','$100/km²','$120/km²','$140/km²','$160/km²','>$160/km²']
    ...
    base = regions.plot(column='bin', ax=ax, cmap='viridis', linewidth=0, 
    ...
    n = len(regions)
    name = f'Direct Damage Cost From Coastal Flooding (2080, RCP8.5, 1-in-1000, 95% CI) (n={n})'
    fig.suptitle(name)
