...
def run_preprocessing(iso3):
    ...
    for region in regions:
        ...
        if regional_level == 1:
            ...
            segment_by_gid_1_sjoin(iso3, 1, region)

            # segment_by_gid_1_old(iso3, 1, region)
...
def segment_by_gid_1_old(iso3, level, region):
    """
...
def segment_by_gid_1_sjoin(iso3, level, region):
    """
    Segment sites by gid_1 bounding box.
